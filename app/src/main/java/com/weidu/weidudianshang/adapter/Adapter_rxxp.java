...
public class Adapter_rxxp extends RecyclerView.Adapter<Adapter_rxxp.Viewholders> {
    Context context;
    List<GoodsBeen.ProductItemBean.ProductItem> list;

    public Adapter_rxxp(Context context, List<GoodsBeen.ProductItemBean.ProductItem> list) {
    ...
    public Viewholders onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = View.inflate(context, R.layout.rxxp_layout, null);
    ...
    public class Viewholders extends RecyclerView.ViewHolder {
        ...
        public Viewholders(@NonNull View itemView) {
            super(itemView);
            dree_adapret_rx = itemView.findViewById(R.id.rxxpImage);
            t1_adapret_rx = itemView.findViewById(R.id.rxxpText1);
            t2_adapret_rx = itemView.findViewById(R.id.rxxpText2);
        }
    }
}
